...
/**
 * Created by gombloh on 24/01/18.
 */
...
public class SortingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        db.orderByChild("nama_kost").addValueEventListener(new ValueEventListener() {
            @Override
...
//                        viewHolder.textHarga.setText("Rp. "+ String.valueOf(dataKost.getHargaPerBulan())+ ".000,-");
                        ...
                        Glide.with(SortingFragment.this).load(dataKost.getFoto()).into(viewHolder.imageView);
